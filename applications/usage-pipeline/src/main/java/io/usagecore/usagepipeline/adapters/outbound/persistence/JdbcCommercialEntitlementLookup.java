...
import io.usagecore.usagepipeline.application.quota.CommercialEntitlementLookup;
import io.usagecore.usagepipeline.application.quota.CommercialEntitlementMatch;
import io.usagecore.usagepipeline.application.quota.SnapshotEntitlementMode;
 ...
 * No Control Plane / Entitlement Runtime compile-time dependency.
 */
@Repository
public class JdbcCommercialEntitlementLookup implements CommercialEntitlementLookup {
    ...
    public JdbcCommercialEntitlementLookup(JdbcTemplate jdbcTemplate) {
