...
/**
 * Transient dependency failure without destroying container data or remapping ports.
 * {@code GenericContainer.stop()} removes the container; pause/unpause keeps identity and volumes.
 */
