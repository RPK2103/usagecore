...
| Process JVM restart with PENDING outbox | Publisher would claim stored rows | PENDING durable | Restart process | ACK/PUBLISHED window | **REASONED BUT NOT EXECUTED** | No K8s process orchestration in this phase |
